...
import lisUsdLogo from 'img/lisUSD.png';
import lunaLogo from 'img/luna.svg';
import usdcLogo from 'img/usdc.svg';
import usdtLogo from 'img/usdt.svg';
import ustLogo from 'img/ust.svg';
import vaiLogo from 'img/vai.svg';
import vrtLogo from 'img/vrt.svg';
import wbnbLogo from 'img/wbnb.svg';
import wethLogo from 'img/weth.svg';
import xvsLogo from 'img/xvs.svg';
